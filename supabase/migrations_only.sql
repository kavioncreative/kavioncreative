-- ========================================================
-- CODESLOGIC CHRONOLOGICAL MIGRATIONS ONLY
-- Generated on: 2026-08-12T07:04:30.616Z
-- ========================================================
...
DROP VIEW IF EXISTS freelancer_performance_ranking CASCADE; CREATE VIEW freelancer_performance_ranking AS
WITH site_stats AS (
    SELECT 
...
DROP VIEW IF EXISTS public.projects_with_collaborators CASCADE; CREATE VIEW public.projects_with_collaborators AS
SELECT 
    p.id,
    p.project_id,
    p.action_move,
...
DROP VIEW IF EXISTS public.projects_list_view CASCADE; CREATE VIEW public.projects_list_view AS
SELECT 
    project_id,
    project_title,
    status,
...
-- Injected by consolidator: Seed workload permissions
INSERT INTO public.permissions (code, name, category, description)
VALUES 
  ('view_workload', 'View Workload', 'Users', 'View Freelancer Workload & Capacity'),
  ('edit_workload', 'Edit Workload', 'Users', 'Edit Freelancer Workload & Capacity')
ON CONFLICT (code) DO NOTHING;
