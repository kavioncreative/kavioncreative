  ...
  try {
    ...
    const res = await fetch('https://api.resend.com/emails', {
      ...
      body: JSON.stringify({
        ...
        to: [email],
        subject: `You're invited to join CodesLogic, ${firstName}!`,
        html: `
          <!DOCTYPE html>
          <html>
          <head>
          ...
          <body style="margin: 0; padding: 0; background-color: #f5f5f5; font-family: 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif;">
            ...
            <div style="display: none; max-height: 0px; overflow: hidden;">
              You've been invited to join the CodesLogic team. Access your credentials and login to get started.
                    ...
                    <tr>
                      <td style="padding: 40px;">
                        ...
                        <p style="font-size: 16px; line-height: 1.6; color: #555555; margin: 0 0 30px 0;">
                          You've been invited to join the CodesLogic team as a new member. Your professional workspace is ready and we've created your credentials below.
                        </p>
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-bottom: 35px;">
                          ...
                          <tr>
                            <td style="padding-bottom: 18px;">
                              <div style="color: #666666; font-size: 13px; font-weight: 500; margin-bottom: 6px;">Login Email</div>
                              <table width="100%" border="0" cellspacing="0" cellpadding="0" style="background-color: #fafafa; border: 1px solid #f0f0f0; border-radius: 8px;">
                                <tr>
                                  <td style="padding: 12px 14px; font-size: 15px; font-weight: 400; color: #555555;">
                                    <span style="color: #555555 !important; text-decoration: none !important; border: none !important; pointer-events: none;">
